...
class UsuarioList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addQuickAction(_t('New'),  new TAction(array('UsuarioForm', 'onEdit')), 'bs:plus-sign green');
        ...
        $container->add(TPanelGroup::pack('Lista de Usuários', $this->form));
    ...
    public function onSearch()
    {
        ...
        TSession::setValue('UsuarioList_filter_CODIGO',   NULL);
        TSession::setValue('UsuarioList_filter_EMAIL',   NULL);

        if (isset($data->CODIGO) AND ($data->CODIGO)) {
            $filter = new TFilter('CODIGO', 'like', "%{$data->CODIGO}%"); // create the filter
            TSession::setValue('UsuarioList_filter_CODIGO',   $filter); // stores the filter in the session
        }


        if (isset($data->EMAIL) AND ($data->EMAIL)) {
            $filter = new TFilter('EMAIL', 'like', "%{$data->EMAIL}%"); // create the filter
            TSession::setValue('UsuarioList_filter_EMAIL',   $filter); // stores the filter in the session
        }
        ...
        TSession::setValue('Usuario_filter_data', $data);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if (TSession::getValue('UsuarioList_filter_CODIGO')) {
                $criteria->add(TSession::getValue('UsuarioList_filter_CODIGO')); // add the session filter
            }


            if (TSession::getValue('UsuarioList_filter_EMAIL')) {
                $criteria->add(TSession::getValue('UsuarioList_filter_EMAIL')); // add the session filter
            }
