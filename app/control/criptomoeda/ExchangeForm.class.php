 ...
 */
class ExchangeForm extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Exchange');
        ...
        $URL = new TEntry('URL');
        $API_PUBLIC = new TEntry('API_PUBLIC');
        ...
        $this->form->addQuickField('Url', $URL,  '100%' );
        $this->form->addQuickField('Api Public', $API_PUBLIC,  '100%' );
        $this->form->addQuickField('Status', $STATUS,  '100%' , new TRequiredValidator);
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Exchange;  // create an empty object
